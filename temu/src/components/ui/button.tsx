  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold font-body ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Bizmix custom variants
        gold: "bg-gold text-navy font-semibold hover:bg-gold-dark shadow-gold hover:shadow-elevated transition-all duration-300",
        "gold-outline": "border-2 border-gold bg-transparent text-gold hover:bg-gold hover:text-navy",
        hero: "bg-gold text-navy font-bold text-base px-8 py-4 hover:bg-gold-dark shadow-gold hover:shadow-elevated animate-pulse-gold hover:animate-none",
        ...
        nav: "bg-transparent text-primary-foreground/80 hover:text-gold font-medium",
      },
      size: {
